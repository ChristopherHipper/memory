    ...
    return `<main class="game" data-theme="${game.board.gameTheme}">
                ...
                <dialog class="dialog" id="my-dialog">
                    ...
                    <div class="btn-wrapper">
                        <button class="continue-btn secondary-btn" commandfor="my-dialog" command="close">No, back to game</button>
                        <button id="endGame" class="button secondary-btn exit-btn">Exit game</button>
                    </div>
                </dialog>
